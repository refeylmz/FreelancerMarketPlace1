    ...
    public partial class initialmig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HomeAboutID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "HomeDevelopedProjects",
                columns: table => new
                {
                    HomeDevelopedProjectID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageURL = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeDevelopedProjects", x => x.HomeDevelopedProjectID);
                });

            migrationBuilder.CreateTable(
                name: "HomeFeatureItems",
                columns: table => new
                {
                    HomeFeatureItemID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeFeatureItems", x => x.HomeFeatureItemID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HomeFindJobID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ButtonURL = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeFindJobs", x => x.HomeFindJobID);
                });

            migrationBuilder.CreateTable(
                name: "HomeProjectItems",
                columns: table => new
                {
                    HomeProjectItemID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImageURL = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeProjectItems", x => x.HomeProjectItemID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyEstablishDate = table.Column<DateTime>(type: "datetime2", nullable: false),
