...
namespace FreelancerMarketPlace1.Migrations
{
    ...
    [Migration("20231221174605_mig_message_added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreelancerMarketPlace1.Models.Model.FreelancerSkill", b =>
                {
                    b.Property<int?>("FreelancerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FreelancerMarketPlace1.Models.Model.Message", b =>
                {
            ...
            modelBuilder.Entity("FreelancerMarketPlace1.Models.Model.Project", b =>
                {
                    ...
                    b.Property<int?>("SkillCalled")
                        .HasColumnType("int");

                    b.Property<string>("SkillCalledSt")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FreelancerMarketPlace1.Models.Model.Skill", b =>
                {
                    b.Property<int>("SkillID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FreelancerProject", b =>
                {
                    b.Property<int>("AppliedFreelancersFreelancerID")
                        .HasColumnType("int");

                    b.Property<int>("AppliedProjectsProjectID")
                        .HasColumnType("int");

                    b.HasKey("AppliedFreelancersFreelancerID", "AppliedProjectsProjectID");
            ...
            modelBuilder.Entity("FreelancerMarketPlace1.Models.Model.FreelancerSkill", b =>
                {
                    b.HasOne("FreelancerMarketPlace1.Models.Model.Freelancer", "Freelancer")
                        .WithMany("FreelancerSkills")
                        .HasForeignKey("FreelancerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FreelancerMarketPlace1.Models.Model.Skill", "Skill")
                        .WithMany("FreelancerSkills")
            ...
            modelBuilder.Entity("FreelancerMarketPlace1.Models.Model.Message", b =>
                {
                    b.HasOne("FreelancerMarketPlace1.Models.Model.AppUser", "ReceiverUser")
                        .WithMany("UserReceiver")
                        .HasForeignKey("ReceiverID");

                    b.HasOne("FreelancerMarketPlace1.Models.Model.AppUser", "SenderUser")
                        .WithMany("UserSender")
            ...
            modelBuilder.Entity("FreelancerProject", b =>
                {
                    b.HasOne("FreelancerMarketPlace1.Models.Model.Freelancer", null)
                        .WithMany()
                        .HasForeignKey("AppliedFreelancersFreelancerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FreelancerMarketPlace1.Models.Model.Project", null)
                        .WithMany()
